function shuffleArray(array) {
  ...
  function initCarousel(selector, isfront) {
    ...
    $.ajax(
    {
        ...
        shuffleArray(ads);
        adNodesToCarousel(ads, selector, autoJobcarousel, autoJobcarouselContainer);        
        }
    }
    );
  }
    
  function adNodesToCarousel (ads, selector, autoJobcarousel, autoJobcarouselContainer) {
        ...
        <a itemprop="url" href="${ad.published_url}">
            ...
            <div class="carousel article-preview-text">
                <div class="carousel-ad-byline">
                    <div class="carousel-ad-company-logo" style="background-image: url(//dbstatic.no/${ad.full_bylines[0].imageUrl})">
                    </div>
